...
public class UiController {
	...
	@RequestMapping("/dispatch/{pcount}")
	public List<Person> sendMessage(@RequestBody String personName,  @PathVariable("pcount") int pcount) {
		return personHystrixService.save(personName,pcount);
	}
